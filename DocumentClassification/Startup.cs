...
namespace DocumentClassification
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<DocumentClassificationContext>(options =>
                    options.UseSqlServer(Configuration.GetConnectionString("DocumentClassificationContext")));
            services.Configure<ClassificationSettings>(Configuration.GetSection("Classification"));
